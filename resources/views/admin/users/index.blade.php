    ...
    <div class="bg-white shadow-xl rounded-xl p-4 sm:p-6">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-4 sm:space-y-0 mb-6">
            ...
            <div class="flex-grow max-w-lg">
                <div class="relative">
                    <input type="text" placeholder="Cari Nama Pengguna..." class="w-full pl-10 pr-4 py-2 border border-gray-200 rounded-lg focus:ring-blue-500 focus:border-blue-500 bg-gray-50 text-gray-700">
                ...
                <tbody class="bg-white divide-y divide-gray-100">
                    ...
                    <tr class="hover:bg-blue-50/50">
                        ...
                        <td class="px-3 py-4 whitespace-nowrap">
                            <img class="h-10 w-10 rounded-full object-cover" src="{{ $user->profile_photo_url ?? 'default-avatar.png' }}" alt="{{ $user->name }}">
                        </td>
