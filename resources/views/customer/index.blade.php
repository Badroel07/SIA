...
<div class="fixed inset-0 -z-10 overflow-hidden pointer-events-none">
    <div class="absolute -top-40 -right-40 w-[500px] h-[500px] bg-gradient-to-br from-blue-400/20 to-indigo-500/20 rounded-full blur-3xl animate-float"></div>
    <div class="absolute top-1/3 -left-40 w-[400px] h-[400px] bg-gradient-to-tr from-purple-400/15 to-pink-400/15 rounded-full blur-3xl animate-float" style="animation-delay: 1.5s;"></div>
    <div class="absolute -bottom-40 right-1/4 w-[350px] h-[350px] bg-gradient-to-tl from-cyan-400/15 to-blue-400/15 rounded-full blur-3xl animate-float" style="animation-delay: 3s;"></div>

    <!-- Geometric decorations -->
    <div class="absolute top-40 right-20 w-64 h-64 border border-blue-200/20 rounded-full animate-rotate-slow"></div>
    <div class="absolute bottom-40 left-20 w-48 h-48 border border-indigo-200/15 rounded-full animate-rotate-slow" style="animation-direction: reverse;"></div>
</div>
    ...
    <div class="container mx-auto px-4 relative z-10">
        <div class="flex flex-col md:flex-row items-center">
            <div class="md:w-1/2 md:pr-10">
                <!-- Badge with glow -->
                <div class="inline-flex items-center gap-2 px-5 py-2 bg-gradient-to-r from-blue-500 to-indigo-600 text-white rounded-full text-sm font-bold mb-6 shadow-lg shadow-blue-500/30 animate-slide-up animate-pulse-glow">
                ...
                <h1 class="text-4xl md:text-5xl lg:text-6xl font-heading font-extrabold text-gray-900 leading-tight mb-6 animate-slide-up" style="animation-delay: 0.1s;">
                    Makes Your Health <br>
                    Better Will Makes <br>
                    Us <span class="bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-600 bg-clip-text text-transparent">Better</span>
                </h1>

                <p class="text-gray-600 text-lg md:text-xl mb-8 max-w-md leading-relaxed animate-slide-up" style="animation-delay: 0.2s;">
...
<div id="katalog" class="container mx-auto px-4 py-16">
    ...
    <div class="text-center mb-12 animate-slide-up">
        <span class="inline-block px-4 py-2 bg-blue-100 text-blue-600 font-bold text-sm rounded-full mb-4">Katalog Produk</span>
        <h2 class="text-4xl md:text-5xl font-heading font-bold text-gray-900 mb-4">
            Temukan <span class="bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent">Obat</span> Anda
        </h2>
        <p class="text-gray-500 max-w-lg mx-auto">Cari dari berbagai macam obat-obatan berkualitas dengan harga terjangkau</p>
        <div class="h-1.5 w-24 bg-gradient-to-r from-blue-600 via-indigo-500 to-purple-600 mx-auto mt-6 rounded-full"></div>
    </div>
    ...
    <div class="glass-card p-6 md:p-8 rounded-3xl shadow-2xl border border-white/50 mb-12 max-w-5xl mx-auto relative animate-scale-in">
        ...
        <form action="{{ route('home') }}" method="GET" class="flex flex-col md:flex-row gap-4 items-center relative z-10"
            ...
            <div class="flex-grow w-full relative group">
                <div class="absolute left-4 top-1/2 -translate-y-1/2 w-12 h-12 rounded-xl bg-blue-50 group-focus-within:bg-blue-100 flex items-center justify-center transition-colors">
            ...
            <!-- Search Button -->
            <button type="submit" class="group w-full md:w-auto px-8 py-4 bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-600 text-white rounded-2xl font-bold flex items-center justify-center gap-3 shadow-xl shadow-blue-500/30 hover:shadow-blue-500/50 transition-all duration-300 hover:scale-105">
                <svg class="w-5 h-5 group-hover:scale-110 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24" x-show="!loading">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"></path>
                </svg>
    ...
    <div id="medicine-results">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            ...
            <div class="product-card group glass-card rounded-3xl overflow-hidden shadow-lg border border-gray-100 hover-lift animate-slide-up" style="animation-delay: {{ ($index % 8) * 0.1 }}s;">
                <!-- Image Container -->
                <div class="product-image relative bg-gradient-to-br from-blue-50 to-indigo-50 h-56 overflow-hidden">
                    <!-- Category Badge -->
                    <span class="absolute top-4 left-4 z-10 px-4 py-1.5 bg-gradient-to-r from-blue-600 to-indigo-600 text-white text-xs font-bold rounded-full shadow-lg">
                        {{ $item->category }}
                    </span>

                    @if($item->image)
                    <img src="{{ Storage::disk('public')->url($item->image) }}" alt="{{ $item->name }}" class="w-full h-full object-cover transition-transform duration-700">
                    @else
                ...
                <div class="p-5">
                    ...
                    <div class="flex items-center justify-between mb-4">
                        ...
                        @if($item->stock > 0)
                        <span class="px-3 py-1 bg-green-100 text-green-600 text-xs font-bold rounded-full flex items-center gap-1">
                    ...
                    <div class="flex gap-2">
                        ...
                        @else
                        <button type="button" disabled class="flex-1 py-3 bg-gray-200 text-gray-500 font-bold rounded-xl cursor-not-allowed">
                            Stok Kosong
                        </button>
                        @endif
