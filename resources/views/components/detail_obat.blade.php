{{-- Modal Detail Obat --}}
<div id="medicineDetailModal" class="hidden fixed inset-0 backdrop-blur-sm backdrop-brightness-50 overflow-y-auto h-full w-full z-50 py-10">
    <div class="relative mx-auto mt-16 p-5 w-full max-w-4xl shadow-2xl rounded-2xl bg-white mb-10">
        {{-- Header Modal --}}
